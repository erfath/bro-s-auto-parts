...
const Banner = () => {
    return (
        <div class="carousel w-full">
            ...
            <h3 className='lg:text-5xl font-bold text-nutral lg:mt-20 lg:ml-20 ml-16  carousel-caption'>Feel The Greate <br /> Power With Latest <br /> <span className='text-primary'>Engine Oil</span> </h3>
