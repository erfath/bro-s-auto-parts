...
const Blogs = () => {
    return (
        <div className='p-5 bg-secondary'>
            <h2 className='text-4xl text-center font-mono font-semibold mb-5'>Here Are Some QA</h2>
            <div>
                <div>
                    <span className='text-2xl font-serif font-semibold'>How will you improve the performance of a React Application?</span>

                    <p> Keeping component state local where necessary. Memoizing React components to prevent unnecessary re-renders. Code-splitting in React using dynamic import() Windowing or list virtualization in React. Lazy loading images in React.
                    </p>
                </div>
                <div>
                    <span className='text-2xl font-serif font-semibold'> What are the different ways to manage a state in a React application?</span>
